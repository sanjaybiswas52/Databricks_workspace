...
# MAGIC %md
# MAGIC #####De-Dupe the datafrome

# COMMAND ----------

results_dedupe_df = results_final_df.dropDuplicates(['race_id', 'driver_id'])
...
merge_delta_data(results_dedupe_df, 'f1_processed', 'results', processed_folder_path, merge_condition, 'race_id')
