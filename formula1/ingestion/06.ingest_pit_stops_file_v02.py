...
from pyspark.sql.functions import current_timestamp, lit, col, lit, current_timestamp, concat_ws, md5
...
#There is not Unique key in the table pit_stops so generated hash_id
