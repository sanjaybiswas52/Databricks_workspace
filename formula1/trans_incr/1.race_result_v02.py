...
# MAGIC LOCATION 's3://databricks02ar/f1/presentation/race_results'
# MAGIC
...
# MAGIC %sql
# MAGIC select file_date, count(*) from f1_presentation.race_results group by file_date order by 1 desc