...
# MAGIC USING parquet
# MAGIC LOCATION 's3://databricks02ar/f1/presentation1/calculated_race_results'
# MAGIC AS
...
# MAGIC %sql
# MAGIC /*INSERT OVERWRITE TABLE f1_presentation.calculated_race_results
# MAGIC SELECT races.race_year,
# MAGIC        constructors.name AS team_name,
# MAGIC        drivers.name AS driver_name,
# MAGIC        results.position,
...
spark.sql(f"""
              CREATE OR REPLACE TEMP VIEW tv_race_result_updated
              AS
...
spark.sql(f"""
              ...
              USING tv_race_result_updated upd
...
# MAGIC %sql
# MAGIC SELECT COUNT(1) FROM tv_race_result_updated;
